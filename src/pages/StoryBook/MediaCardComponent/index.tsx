        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <Card className="p-4 space-y-3 bg-card border w-full max-w-[320px]">
            <div className="w-full h-36 bg-blue-950 rounded-lg relative flex items-end p-2.5">
              <div className="absolute top-2.5 right-2.5 w-6 h-6 bg-black/40 rounded-full flex items-center justify-center">
            ...
            <Badge variant="destructive" className="text-xs">Watching</Badge>
          </Card>
          ...
          <Card className="p-4 space-y-3 bg-card border opacity-50 w-full max-w-[320px]">
            ...
            <Badge variant="secondary" className="text-xs">Not Worth It</Badge>
          </Card>
